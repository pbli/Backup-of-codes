...
int mympu_open(unsigned int rate) {
	...
	short accel_bias[3];
	accel_bias[0]=-7200;//3250;// accl calibration Pengbo li this is very important
	accel_bias[1]=-1500;
	accel_bias[2]=4400;
...
int mympu_update( int i) {
	...
	//mympu.roll  = atan2(_2q01+_2q23, 1-_2q22 -_2q11);
	//mympu.pitch = asin(-_2q13+_2q02);
	//mympu.yaw= atan2(_2q03+_2q12, 1-_2q33 -_2q22);
	//
	//mympu.yaw *= 90.0f / PI_2;
	//mympu.pitch*= 90.0f / PI_2;
	//mympu.roll *= 90.0f / PI_2;
	
	//accl[0]=accl[0]*9.8/9.8;
	//accl[1]=accl[1]*9.85/9.8;
	//accl[2]=accl[2]*9.8/10;
	...
	//mympu.acclw[3*i+2]=9800+(-(_2q13-_2q02)*(float)accl[0]-(_2q23+_2q01)*(float)accl[1]-(1-_2q11-_2q22)*(float)accl[2])*g/ACCL_SENS;
	//
	//sensor frame
	
	mympu.acclw[3*i+0]=(accl[0]-(_2q13-_2q02)*16384)*g/ACCL_SENS;
	mympu.acclw[3*i+1]=(accl[1]-(_2q23+_2q01)*16384)*g/ACCL_SENS;
	mympu.acclw[3*i+2]=((float)accl[2]-(1-_2q11-_2q22)*16384)*g/ACCL_SENS;
